...
MCP(Model Context Protocol)는 LLM이 외부 시스템과 표준화된 방식으로 상호작용할 수 있도록 해주는 오픈 프로토콜입니다.  Amazon Q CLI에서는 \~/.aws/amazonq/mcp.json 파일을 통해 MCP 서버를 설정합니다.
